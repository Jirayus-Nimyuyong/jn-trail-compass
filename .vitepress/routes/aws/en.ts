export const EN = [
  {
    ...
    items: [
      ...
      { 
        text: 'API Gateway', 
        collapsed: true,
        base: '/aws/networking-&-content-delivery/api-gateway',
        link: '/api-gateway', 
        items: [
  ...
  },   
  {
    ...
    items: [
      ...
      { 
        text: 'EC2', 
        collapsed: true,
        link: '/aws/compute/ec2/ec2', 
        items: [
          { text: 'EC2 Instance Types', link: '/aws/compute/ec2/ec2-instance-types.md' },
          { text: 'Security Groups', link: '/aws/compute/ec2/security-groups.md' },
          { text: 'SSH', link: '/aws/compute/ec2/ssh.md' },
          { text: 'EC2 Instance Connect', link: '/aws/compute/ec2/ec2-instance-connect.md' },
          { text: 'EC2 Instance Roles', link: '/aws/compute/ec2/ec2-instance-roles.md' },
          { text: 'EC2 Instance Purchasing Options', link: '/aws/compute/ec2/ec2-instance-purchasing-options.md' },
          { text: 'EBS', link: '/aws/compute/ec2/ebs.md' },
          { text: 'EBS-Snapshots', link: '/aws/compute/ec2/ebs-snapshots.md' },
          { text: 'AMI', link: '/aws/compute/ec2/ami.md' },
          { text: 'EC2 Instance Store', link: '/aws/compute/ec2/ec2-instance-store.md' },
          { text: 'EBS Volume Types', link: '/aws/compute/ec2/ebs-volume-types.md' },
          { text: 'EBS Multi-Attach', link: '/aws/compute/ec2/ebs-multi-attach.md' },
          { text: 'ELB', link: '/aws/compute/ec2/elb.md' },
          { text: 'CLB', link: '/aws/compute/ec2/clb.md' },
          { text: 'ALB', link: '/aws/compute/ec2/alb.md' },
          { text: 'NLB', link: '/aws/compute/ec2/nlb.md' },
          { text: 'GWLB', link: '/aws/compute/ec2/gwlb.md' },
          { text: 'ASG', link: '/aws/compute/ec2/asg.md' },
          { text: 'Instance Metadata', link: '/aws/compute/ec2/instance-metadata.md' },
          { text: 'Nitro Enclavesa', link: '/aws/compute/ec2/nitro-enclavesa.md' },
        ]
      },
      ...
      { 
        ...
        items: [
          ...
          { text: 'File Systems Mounting', link: '/fiServerless Applicationle-systems-mounting' },
      ...
      { 
        ...
        collapsed: true,
        link: '/aws/compute/beanstalk/elastic-beanstalk', 
        items: [
          { text: 'Beanstalk Deployment Modes', link: '/aws/compute/beanstalk/beanstalk-deployment-modes.md' },
          { text: 'Elastic Beanstalk CLI', link: '/aws/compute/beanstalk/cli.md' },
          { text: 'Beanstalk Lifecycle Policy', link: '/aws/compute/beanstalk/beanstalk-lifecycle-policy.md' },
          { text: 'Elastic Beanstalk Extensions', link: '/aws/compute/beanstalk/elastic-beanstalk-extensions.md' },
          { text: 'Beanstalk & CloudFormation', link: '/aws/compute/beanstalk/beanstalk-cloudFormation.md' },
          { text: 'Beanstalk Cloning', link: '/aws/compute/beanstalk/beanstalk-cloning.md' },
          { text: 'Beanstalk Migrations', link: '/aws/compute/beanstalk/beanstalk-migrations.md' },
        ]
      },
  ...
  },
  {
    ...
    items: [
      ...
      { 
        ...
        collapsed: true,
        link: '/aws/containers/ecs/ecs', 
        items: [
          { text: 'ECS Cluster', link: '/aws/containers/ecs/ecs-cluster' },
          { text: 'ECS Service', link: '/aws/containers/ecs/ecs-service' },
          { text: 'ECS Auto Scaling', link: '/aws/containers/ecs/ecs-auto-scaling' },
          { text: 'ECS Rolling Updates', link: '/aws/containers/ecs/ecs-rolling-updates' },
          { text: 'ECS Solutions Architectures', link: '/aws/containers/ecs/ecs-solutions-architectures' },
          { text: 'ECS Task Definitions', link: '/aws/containers/ecs/ecs-task-definitions' },
          { text: 'ECS Task Placement', link: '/aws/containers/ecs/ecs-task-placement' },
          
        ]
      },
      { text: 'Elastic Container Registry', link: '/aws/containers/elastic-container-registry' },
      { text: 'Copilot', link: '/aws/containers/copilot' },
  ...
  },
  {
    ...
    items: [
      ...
      { 
        text: 'S3', 
        collapsed: true,
        link: '/aws/storage/s3/s3',
        items: [
          { text: 'Bucket Policies', link: '/aws/storage/s3/bucket-policies.md' },
          { text: 'Static Website Hosting', link: '/aws/storage/s3/static-website-hosting.md' },
          { text: 'Versioning', link: '/aws/storage/s3/versioning.md' },
          { text: 'Replication', link: '/aws/storage/s3/replication.md' },
          { text: 'Storage Classes', link: '/aws/storage/s3/storage-classes.md' },
          { text: 'Lifecycle', link: '/aws/storage/s3/lifecycle.md', },
          { text: 'Event Notifications', link: '/aws/storage/s3/event-notifications.md', },
          { text: 'Performance', link: '/aws/storage/s3/performance.md', },
          { text: 'Metadata & S3 Object Tags', link: '/aws/storage/s3/metadata-&-object-tags.md', },
          { text: 'Encryption', link: '/aws/storage/s3/encryption.md', },
          { text: 'CORS', link: '/aws/storage/s3/cors.md', },
          { text: 'MFA Delete', link: '/aws/storage/s3/mfa-delete.md', },
          { text: 'Access Logs', link: '/aws/storage/s3/access-logs.md', },
          { text: 'Pre-Signed URLs', link: '/aws/storage/s3/pre-signed-urls.md', },
          { text: 'Access Points', link: '/aws/storage/s3/access-points.md', },
          { text: 'S3 Object Lambda', link: '/aws/storage/s3/object-lambda.md', },
        ]
      },
      { 
        text: 'EFS', 
        collapsed: true,
        link: '/aws/storage/efs', 
      },
  ...
  // },
  {
    ...
    items: [
      ...
      { 
        text: 'CodeBuild', 
        collapsed: true,
        link: '/aws/developer-tools/codebuild/codebuild', 
        items: [
          { text: 'CodeBuild Security', link: '/aws/developer-tools/codebuild/codebuild-security' },
        ]
      },
      ...
      { 
        text: 'X-Ray', 
        collapsed: true,
        link: '/aws/developer-tools/x-ray/x-ray', 
        items: [
          { text: 'Instrumentation & Concepts', link: '/aws/developer-tools/x-ray/instrumentation-and-concepts' }, 
          { text: 'Sampling Rules', link: '/aws/developer-tools/x-ray/samplingrules' }, 
          { text: 'APIs', link: '/aws/developer-tools/x-ray/apis' },
          { text: 'X-Ray with Elastic Beanstalk', link: '/aws/developer-tools/x-ray/x-ray-with-elastic-beanstalk' },
          { text: 'X-Ray with ECS', link: '/aws/developer-tools/x-ray/x-ray-with-ecs' },
          { text: 'Distro for OpenTelemetrCloudy', link: '/aws/developer-tools/x-ray/distro-for-opentelemetry' }
      ...
      { 
        text: 'CDK', 
        collapsed: true,
        link: '/aws/developer-tools/cdk/cdk', 
        items: [
          { text: 'CDK Constructs', link: '/aws/developer-tools/cdk/cdk-constructs' }, 
          { text: 'Commands & Bootstrapping', link: '/aws/developer-tools/cdk/commands-bootstrapping' },
          { text: 'Testing', link: '/aws/developer-tools/cdk/testing' },
        ]
      },      
  ...
  // },    
  {
    ...
    items: [
      ...
      { 
        text: 'CloudWatch', 
        collapsed: true,
        link: '/aws/management-&-governance/cloudwatch/cloudwatch', 
        items: [
          { text: 'Metrics', link: '/aws/management-&-governance/cloudwatch/metrics' },
          { text: 'Logs', link: '/aws/management-&-governance/cloudwatch/logs' },
          { text: 'Logs - Encryption', link: '/aws/management-&-governance/cloudwatch/logs-encryption' },
          { text: 'Alarms', link: '/aws/management-&-governance/cloudwatch/alarms' },
          { text: 'Synthetics', link: '/aws/management-&-governance/cloudwatch/synthetics' },
          { text: 'Evidently', link: '/aws/management-&-governance/cloudwatch/evidently' },
      ...
      { 
        text: 'CloudFormation', 
        collapsed: true,
        link: '/aws/management-&-governance/cloudformation/cloudformation',
        items: [
          { text: 'YAML', link: '/aws/management-&-governance/cloudformation/yaml' },
          { text: 'Resources', link: '/aws/management-&-governance/cloudformation/resources' },
          { text: 'Parameters', link: '/aws/management-&-governance/cloudformation/parameters' },
          { text: 'Mappings', link: '/aws/management-&-governance/cloudformation/mappings' },
          { text: 'Outputs', link: '/aws/management-&-governance/cloudformation/outputs' },
          { text: 'Condition', link: '/aws/management-&-governance/cloudformation/condition' },
          { text: 'Intrinsic Functions', link: '/aws/management-&-governance/cloudformation/intrinsic-functions' },
          { text: 'Rollbacks', link: '/aws/management-&-governance/cloudformation/rollbacks' },
          { text: 'Service Role', link: '/aws/management-&-governance/cloudformation/service-role' },
          { text: 'Capabilities', link: '/aws/management-&-governance/cloudformation/capabilities' },
          { text: 'DeletionPolicy', link: '/aws/management-&-governance/cloudformation/deletionPolicy' },
          { text: 'Stack Policies', link: '/aws/management-&-governance/cloudformation/stack-policies' },
          { text: 'Termination Protection', link: '/aws/management-&-governance/cloudformation/termination-protection' },
          { text: 'Custom Resources', link: '/aws/management-&-governance/cloudformation/custom-resources' },
          { text: 'StackSets', link: '/aws/management-&-governance/cloudformation/stackSets' },
          {text: 'Dynamic References', link: '/aws/management-&-governance/cloudformation/dynamic-feferences'  }
        ]
      },
      ...
      { 
        ...
        collapsed: true,
        link: '/aws/management-&-governance/systems-manager/systems-manager',
        items: [
          { text: 'SSM Parameter Store', link: '/aws/management-&-governance/ssm-parameter-store' },
        ]
      },
      ...
      { 
        text: 'CloudTrail', 
        collapsed: true,
        link: '/aws/management-&-governance/cloudtrail/cloudtrail',
        items: [
          { text: 'CloudTrail EventBridge', link: '/aws/management-&-governance/cloudtrail/cloudtrail-eventbridge' },
          { text: 'CloudTrail vs CloudWatch vs X-Ray', link: '/aws/management-&-governance/cloudtrail/cloudtrail-vs-cloudwatch-vs-x-ray' },
  ...
  },   
  {
    ...
    items: [
      ...
      { 
        text: 'Cognito', 
        collapsed: true,
        link: '/aws/security-identity-&-compliance/cognito/cognito', 
        items: [
           { text: 'User Pools', link: '/aws/security-identity-&-compliance/cognito/user-pools' }, 
           { text: 'ALB Auth Users', link: '/aws/security-identity-&-compliance/cognito/alb-auth-users' },
           { text: 'Identity Pools', link: '/aws/security-identity-&-compliance/cognito/identity-pools' },
        ]
      },
      ...
      { 
        ...
        collapsed: true,
        link: '/aws/security-identity-&-compliance/iam-identity-center/iam-identity-center', 
        items: [
          { text: 'STS', link: '/aws/security-identity-&-compliance/iam-identity-center/sts' }
        ]
      },
      { text: 'Certificate Manager', link: '/aws/security-identity-&-compliance/certificate-manager' },
      { text: 'Encryption', link: '/aws/security-identity-&-compliance/encryption' },
      { 
        text: 'Key Management Service', 
        collapsed: true,
        link: '/aws/security-identity-&-compliance/kms/key-management-service', 
        items: [
          { text: 'Encrypt and Decrypt', link: '/aws/security-identity-&-compliance/kms/encrypt-and-decrypt' }, 
          { text: 'KMS Limits', link: '/aws/security-identity-&-compliance/kms/kms-limits' },
          { text: 'KMS Lambda', link: '/aws/security-identity-&-compliance/kms/kms-and-lambda' },
          { text: 'KMS S3 Bucket', link: '/aws/security-identity-&-compliance/kms/kms-s3-bucket' },
          { text: 'KMS Key Policies & IAM', link: '/aws/security-identity-&-compliance/kms/kms-key-policies-iam' },
      ...
      { 
        text: 'IAM', 
        collapsed: true,
        link: '/aws/security-identity-&-compliance/IAM/iam.md',
        items: [
          { text: 'IAM Policies', link: '/aws/security-identity-&-compliance/IAM/iam-policies.md' }, 
          { text: 'IAM MFA', link: '/aws/security-identity-&-compliance/IAM/iam-mfa.md' }, 
          { text: 'AWS Access', link: '/aws/security-identity-&-compliance/IAM/aws-access.md' }, 
          { text: 'IAM Roles', link: '/aws/security-identity-&-compliance/IAM/iam-roles.md' }, 
          { text: 'IAM Security Tools', link: '/aws/security-identity-&-compliance/IAM/iam-security-tools.md' },
          { text: 'IAM Best Practices', link: '/aws/security-identity-&-compliance/IAM/iam-best-practices.md' },
          { text: 'Shared Responsibility Model for IAM', link: '/aws/security-identity-&-compliance/IAM/shared-responsibility-model-for-iam.md' },
          { text: 'IAM Summary', link: '/aws/security-identity-&-compliance/IAM/iam-summary.md' },
          { text: 'Advanced IAM', link: '/aws/security-identity-&-compliance/IAM/advanced-iam' },
          { text: 'Pass Role', link: '/aws/security-identity-&-compliance/IAM/pass-role' },
        ]
      },
  ...
  },   
  {
    ...
    items: [
      ...
      { 
        ...
        link: '/aws/cloud-financial-management/billing-and-cost-management/billing-and-cost-management', 
        items: [
          { text: 'AWS Budget', link: '/aws/cloud-financial-management/billing-and-cost-management/aws-buget.md' }, 
        ]
      },
    ]
  },     
  ...
  },  
  {
    ...
    items: [
      ...
      { 
        text: 'Step Functions', 
        base: '/aws/application-integration/step-functions',
        link: '/step-functions', 
        items: [
      ...
      { 
        ...
        collapsed: true,
        link: '/aws/application-integration/sqs/simple-queue-service',
        items: [
          { text: 'Access Policy', link: '/aws/application-integration/sqs/access-policy' }, 
          { text: 'Message Visibility Timeout', link: '/aws/application-integration/sqs/message-visibility-timeout' }, 
          { text: 'Dead Letter Queue', link: '/aws/application-integration/sqs/dead-letter-queue' }, 
          { text: 'Delay Queue', link: '/aws/application-integration/sqs/delay-queue' }, 
          { text: 'FIFO Queue', link: '/aws/application-integration/sqs/fifo-queue' }, 
          { text: 'Certified Developer Concepts', link: '/aws/application-integration/sqs/certified-developer-concepts' }, 
        ]
      },
